 ...
 * @param certificate InputFile <b>Optional</b> Upload your public key certificate so that the root certificate in use can be checked. See our self-signed guide for details.
 * @param max_connections integer <b>Optional</b> Maximum allowed number of simultaneous HTTPS connections to the webhook for update delivery, 1-100. Defaults to 40. Use lower values to limit the load on your bot‘s server, and higher values to increase your bot’s throughput.
...
class setWebhook extends telegramMethod{
    ...
    protected $requireds=['url'=>'string'];

    protected $optionals=['certificate'=>'InputFile','max_connections'=>'integer','allowed_updates'=>'Array of string'];
